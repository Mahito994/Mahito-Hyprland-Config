...
PanelWindow {
    ...
    QtObject {
        id: theme
        property color card: win.isDarkMode ? "#282C34" : "#EBE9DE"
        property color tile: win.isDarkMode ? "#21252B" : "#E2DFD3"
        property color tileHover: win.isDarkMode ? "#21252B" : "#D1CEC0"
        property color text: win.isDarkMode ? "#979EAB" : "#5C6A72"
        property color accent: win.isDarkMode ? '#61AFEF' : "#6c8453"
        property color danger: win.isDarkMode ? "#E06C75" : "#F85552"
        property color activeText: win.isDarkMode ? "#21252B" : "#F2F0E5"
